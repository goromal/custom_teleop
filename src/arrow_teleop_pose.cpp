...
void ArrowTeleopPose::updateMessage(int key, geometry_msgs::Pose &msg) {
  switch(key) {
    case KEY_PRESS_RIGHT: msg.position.x += POSE_INCREMENT; break;
    case KEY_PRESS_LEFT: msg.position.x -= POSE_INCREMENT; break;
    case KEY_PRESS_UP: msg.position.y += POSE_INCREMENT; break;
    case KEY_PRESS_DOWN: msg.position.y -= POSE_INCREMENT; break;
    case KEY_PRESS_E: msg.position.z += POSE_INCREMENT; break;
    case KEY_PRESS_D: msg.position.z -= POSE_INCREMENT; break;
  }
}
